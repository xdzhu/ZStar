...
每次 v2 提交运行当前完整 suite。独立 worktree 当前实测为 `508 passed, 1158 warnings`，
加入首/末力块解析、Gamma 力拟合 API、force/stress 对称表示、Cartesian rotation 审计和 ResponseDocument 结果封装后，v2 专项测试收集为 115 项。用户的其它工作树可能包含尚未合入
v2 的额外测试或
