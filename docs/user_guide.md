<p align="center">
  <img src="logo.png" alt="ZStar logo" width="176">
</p>
...
<p align="center">
  English | <a href="user_guide.zh-CN.md">简体中文</a> |
  <a href="README.en.pdf">English PDF</a> |
  <a href="README.zh-CN.pdf">中文 PDF</a>
</p>

---

[Project Quick Start](../README.md#quick-start) | [Task-based documentation](README.md)
...
If you do not need to reproduce the examples, run `pip install zstar` and start
using ZStar directly. To obtain the
...
Create a separate working copy so that the supplied inputs and archived results
remain unchanged:
...
Start with the [user manual](README.md) for task-based tutorials, configuration,
examples and capability boundaries.

The numerical checks used for the current release are summarized in [docs/validation.md](validation.md).

The Unified ABACUS + PYATB workflow shares Phonopy-generated
displacements between BEC and Gamma phonons. See the
[Unified BEC/phonon guide](research/shared_response/USAGE.md) and
...
The [Unified spectroscopy guide](unified_spectroscopy.md) explains how the
...
displacement amplitude. The [direct validation report](research/shared_response/DIRECT_VALIDATION.md)
...
1D Coulomb cutoff. See the [one-dimensional workflow](one_dimensional_workflow.md).
...
The repository contains reproducible inputs and retained reference results.
Examples are not included in the PyPI package.
...
completion checks. See [docs/agent_skill.md](agent_skill.md).
...
[job-header tutorial](job_headers.md). Legacy resource flags and
...
[docs/validation.md](validation.md#scheduler-backend-smoke-checks).
...
`cp2k-bec compare`. See the [complete CP2K guide](cp2k_bec.md) for tensor
...
[complete VASP guide](vasp_bec.md) documents finite-field safeguards,
...
The [native response guide](vasp_native_response.md) explains tensor
...
[Point-group activity validation](point_group_activity_validation.md).
...
units are specified in [response definitions and units](response_conventions.md).
The complete convention, bulk and two-dimensional examples, and output
contract are documented in the
[dielectric-response guide](dielectric_response.md).
...
[Molecular IR and Raman spectroscopy](molecular_spectroscopy.md).
...
[calculator spectroscopy guide](calculator_spectroscopy.md). A complete
...
and [figure archive](paper_figures/README.md).

<p align="center" class="efficiency-figure">
  <img src="paper_figures/unified_efficiency_benchmarks.png" alt="Measured Separate and Unified workflow costs for BEC, phonon, IR and Raman calculations" width="820">
</p>
...
<p align="center">
  <img src="paper_figures/spectroscopy_across_dimensions.png" alt="IR and Raman spectra for bulk, slab, nanowire, and molecule" width="820">
</p>

The four-row comparison covers tetragonal HfO2
...
<p align="center">
  <img src="paper_figures/dielectric_response_examples.png" alt="Static and frequency-dependent dielectric response for tetragonal HfO2 and monolayer MoS2" width="820">
</p>
...
Commands, interpretation limits, and the SnS/SnSe/SnTe directional examples are collected in [docs/potential_examples.md](potential_examples.md).
...
See the [complete CLI reference](cli_reference.md) for aliases, leaf
