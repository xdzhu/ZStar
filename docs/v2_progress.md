...
按每个几何自身的非正交晶格基底完成转换后，raw/improper `e15=+0.41040 C/m²`；
施加 reference-branch proper 几何项 `-0.66453 C/m²` 后得到 `e15=-0.25413 C/m²`、
`C44=91.84 GPa` 和 `d15=-2.767 pC/N`，与 `±0.001/±0.002` 稳定值一致，确认
原 `±0.0005` 异常是收敛噪声而非坐标变换错误。cu26 曾因启动
