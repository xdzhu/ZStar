...
| Case | Purpose / 用途 |
|---|---|
| [cubic_BaTiO3](cubic_BaTiO3/) | Cubic PBEsol unified/Cartesian efficiency benchmark / 立方相效率对照 |
...
| [HfO2](HfO2/) | Tetragonal PBEsol paper BEC and dielectric results / 论文介电结果 |
| [t_HfO2](t_HfO2/) | Matched unified/Cartesian benchmark / 同设置效率对照 |
| [SiC](SiC/) | 3C-SiC PBE unified/Cartesian benchmark / 统一框架对照 |
