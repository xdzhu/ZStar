# CH4: Unified versus Cartesian response

CH4 optimized in its supplied PBE basis in a 20-Angstrom cubic cell; Gamma sampling, 100 Ry, SCF 1e-8.

The matched Cartesian central control has 12 displacements; the Unified
Phonopy-auto ensemble has 3. Each adds one reference SCF. Every displaced
...
Install ZStar and PYATB, then configure the ABACUS path
...
```bash
python examples/Benchmarks/run_control.py CH4
```
