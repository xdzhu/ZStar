...
| `VASP_Native_Response/` | native VASP BEC, Gamma modes, dielectric, piezoelectric and elastic response; mixed Raman | 3C-SiC, wurtzite AlN |
| `Piezoelectric_Response/` | proper bulk finite-strain and native-response validation | wurtzite AlN and ZnO |
...
| `Convergence_Tests/` | compact numerical convergence protocols | SiC displacement magnitude and monolayer hBN vacuum separation |
