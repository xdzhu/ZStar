...
def test_public_piezoelectric_api_exposes_workflow_entry_points():
    from zstar import piezoelectric

    assert callable(piezoelectric.prepare_abacus_strain_ensemble)
    assert callable(piezoelectric.collect_abacus_strain_response)
    assert callable(piezoelectric.collect_vasp_strain_response)
    assert callable(piezoelectric.convert_piezoelectric_forms)
